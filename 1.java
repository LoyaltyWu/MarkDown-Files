...
public class ImageTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private ImageTargets mActivity;// 看到没有！是可以直接用的(slime类通信问题，反过来)
    ...
    {
        mActivity = activity;// 在这边实现通信！！？？？我好像是要在那边实现通信来告诉你诶！！。。。。。// 看到没有！是可以直接用的(slime类通信问题，反过来)
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            if (!mActivity.isExtendedTrackingActive()) {
                ...
                Matrix.translateM(modelViewMatrix, 0, 0.0f, 0.0f,
                        OBJECT_SCALE_FLOAT);
                Matrix.rotateM(modelViewMatrix, 0, (float) (y * 0.5), 1.0f, 0, 0);// 这是怎么了。。。。slime
                Matrix.rotateM(modelViewMatrix, 0, (float) (x * 0.5), 0, 1.0f, 0);// 这是怎么了。。。。slime
                Matrix.scaleM(modelViewMatrix, 0, OBJECT_SCALE_FLOAT,
                        OBJECT_SCALE_FLOAT, OBJECT_SCALE_FLOAT);
            } else {
                Matrix.rotateM(modelViewMatrix, 0, 90.0f, 1.0f, 0, 0);// 这是怎么了。。。。slime
                Matrix.scaleM(modelViewMatrix, 0, kBuildingScale,// 这又怎么了。。。。我这不还没调手势呢，你就调了干嘛呀slime
